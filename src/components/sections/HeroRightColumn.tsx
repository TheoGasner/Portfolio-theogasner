  ...
  return (
    ...
    >
      ...
      <motion.a
        ...
        download
        className="inline-flex items-center gap-2 px-8 py-3 bg-white/10 text-white font-semibold rounded-lg border border-white/30 backdrop-blur-sm hover:bg-gradient-to-r hover:from-electric-600/80 hover:via-cyan-600/80 hover:to-neon-700/80 hover:border-transparent hover:text-white transition-all duration-300 no-underline"
