  ...
  return (
    ...
    >
      ...
      <motion.a
        ...
        download
        className="inline-flex items-center gap-2 px-8 py-3 bg-white/10 text-white font-semibold rounded-lg border border-white/30 backdrop-blur-sm hover:bg-gradient-to-r hover:from-electric-400 hover:via-cyan-300 hover:to-neon-400 hover:border-transparent hover:text-dark-950 transition-all duration-300"
